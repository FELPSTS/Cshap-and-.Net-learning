...

                {
                    ...
                    do
                    {
                        ...
                        if (n1 == 111)
                        {
                            ...
                            listBox1.Items.Add("cacetinho,\t R$5,00 \t\t" + n2 + "\t R$" + (this.total1));
                        }
                        if (n1 == 222)
                        {
                            (this.vquant2) = 3 * n2;
                            (this.total2) = (this.total2) + (this.vquant2);
                            listBox1.Items.Add("S. Bergamota,\t R$3,00 \t\t" + n2 + "\t R$" + (this.total2));
                        }
                        if (n1 == 333)
                        {
                            (this.vquant3) = 1 * n2;
                            (this.total3) = (this.total3) + (this.vquant3);
                            listBox1.Items.Add("Negrito,\t\t R$1,00 \t\t" + n2 + "\t R$" + (this.total3));
                        }
